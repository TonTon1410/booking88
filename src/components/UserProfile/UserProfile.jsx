...
const UserProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(
        "Cập nhật thông tin thất bại. Vui lòng thử nhập Email hoặc Số điện thoại khác."
      );
    }
  };
  ...
  return (
    <div className="account-page">
      ...
      <div className="account-nav">
        ...
        <button
          className={`nav-link ${activeTab === "topUpHistory" ? "active" : ""}`}
          onClick={() => handleTabChange("topUpHistory")}
        >
                    ...
                    <td>
                      <ul>
                        {history.bookingDetails.map((detail) => (
                          <li key={detail.courtSlot?.id || detail.id}>
                            {detail.courtSlot?.slot?.time || "N/A"}
                          </li>
                        ))}
                      </ul>
                    </td>
      ...
      >
        {selectedQRCode &&
          bookingHistory
            .find((history) => history.id === selectedQRCode)
