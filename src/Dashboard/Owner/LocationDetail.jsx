...
import { Table, Button, message, Card, Row, Col, Tag, Divider, Modal, Form, Input, InputNumber } from 'antd';
                ...
                <Row gutter={16}>
                    ...
                    <Col span={8}>
                        <Card>
                            ...
                            <p><strong>Hotline:</strong> {location.hotline}</p>
                            <p><strong>Giờ mở cửa:</strong> {location.openingTime}</p>
                            <p><strong>Giờ đóng cửa:</strong> {location.closingTime}</p>
                        </Card>
                    </Col>
                    <Col span={8}>
                        <Card>
                            <p><strong>Trạng thái:</strong> <Tag color={location.status === "ACTIVE" ? "green" : "red"}>{location.status}</Tag></p>
                            <p><strong>Chủ sở hữu:</strong> {location.owner.name}</p>
